...
//    void shiftDownstreamShoots(uint plantID, std::vector<std::shared_ptr<Shoot>> &shoot_tree, std::shared_ptr<Shoot> parent_shoot_ptr, const helios::vec3 &base_position );
    ...
    void initializeBlueberryShoots();

    uint buildBlueberryBush( const helios::vec3 &base_position );

    void initializeCapsicumShoots();

    uint buildCucumber_Vine( const helios::vec3 &base_position );
    ...
    void initializeGingerShoots();

    uint buildGingerPlant( const helios::vec3 &base_position );
    ...
    void initializeOrangeTreeShoots();

    uint buildOrangeTree( const helios::vec3 &base_position );
    ...
    void initializeTurmericShoots();

    uint buildTurmericPlant( const helios::vec3 &base_position );
